...
document.getElementById('blackout').addEventListener('click', () => {
    set(ref(db, 'settings'), { animation: "blackout", color1: "#000000", color2: "#000000" });
});

document.getElementById('logo').addEventListener('click', () => {
    set(ref(db, 'settings'), { animation: "logo", message: "Tudo certo! Aguarde nosso culto começar…" });
});
...
document.getElementById('blink').addEventListener('click', () => {
    ...
    set(ref(db, 'settings'), { animation: "blink", color1, color2, blinkTime });
});
